<div class="lg:flex">
    <div class="flex-1 p-2">
        <label for="app-payload-host" class="form-label">{{ __('app-create.payload.host') }}</label>
    ...
    <div class="flex-1 p-2">
        <label for="app-payload-port" class="form-label">{{ __('app-create.payload.port') }}</label>
        <input type="number" name="payload[port]" class="form-control form-control-lg" id="app-payload-port" value="{{ $REQUEST->input('payload.port') }}" step="1" />
    </div>
</div>
