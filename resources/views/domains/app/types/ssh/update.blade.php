...
<div class="p-2">
    ...
    <label for="app-payload-public" class="form-label">{{ __('app-update.payload.public') }}</label>
...
<div class="p-2">
    ...
    <label for="app-payload-private" class="form-label">{{ __('app-update.payload.private') }}</label>
