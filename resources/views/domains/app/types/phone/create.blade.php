<div class="lg:flex">
    ...
    <div class="flex-1 p-2">
        <label for="app-payload-sim" class="form-label">{{ __('app-create.payload.sim') }}</label>
...
<div class="lg:flex">
    ...
    <div class="flex-1 p-2">
        <label for="app-payload-puk" class="form-label">{{ __('app-create.payload.puk') }}</label>
    ...
    <div class="flex-1 p-2">
        <label for="app-payload-unlock" class="form-label">{{ __('app-create.payload.unlock') }}</label>
