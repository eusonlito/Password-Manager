<div class="lg:flex">
    <div class="flex-1 p-2">
        <label for="app-payload-username" class="form-label">{{ __('app-create.payload.username') }}</label>
    ...
    <div class="flex-1 p-2">
        <label for="app-payload-key" class="form-label">{{ __('app-create.payload.key') }}</label>

        <div class="input-group">
            <input type="password" name="payload[key]" class="form-control form-control-lg" id="app-payload-key" value="{{ $REQUEST->input('payload.key') }}" step="1" />

            <button type="button" class="input-group-text input-group-text-lg tooltip" data-tippy-content="{{ __('common.copied') }}" title="{{ __('common.copy') }}" data-copy data-copy-target="#app-payload-key" tabindex="-1">@icon('clipboard', 'w-5 h-5')</button>
            <button type="button" class="input-group-text input-group-text-lg" title="{{ __('common.show') }}" data-password-show="#app-payload-key" tabindex="-1">@icon('eye', 'w-5 h-5')</button>
        </div>
    </div>
</div>
