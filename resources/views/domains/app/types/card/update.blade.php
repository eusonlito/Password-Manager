<div class="lg:flex">
    <div class="flex-1 p-2">
        <label for="app-payload-holder" class="form-label">{{ __('app-update.payload.holder') }}</label>

        <div class="input-group">
            <input type="password" name="payload[holder]" class="form-control form-control-lg" id="app-payload-holder" value="{{ $REQUEST->input('payload.holder') }}" />
            ...
            <button type="button" class="input-group-text input-group-text-lg" title="{{ __('common.show') }}" data-password-show="#app-payload-holder" tabindex="-1">@icon('eye', 'w-5 h-5')</button>
        </div>
    </div>
    ...
    <div class="flex-1 p-2">
        ...
        <div class="input-group">
            <input type="password" name="payload[number]" class="form-control form-control-lg" id="app-payload-number" value="{{ $REQUEST->input('payload.number') }}" />
            ...
            <button type="button" class="input-group-text input-group-text-lg" title="{{ __('common.show') }}" data-password-show="#app-payload-number" tabindex="-1">@icon('eye', 'w-5 h-5')</button>
        </div>
    </div>
</div>
...
<div class="lg:flex">
    ...
    <div class="flex-1 p-2">
        <label for="app-payload-cvc" class="form-label">{{ __('app-update.payload.cvc') }}</label>

        <div class="input-group">
            <input type="password" name="payload[cvc]" class="form-control form-control-lg" id="app-payload-cvc" value="{{ $REQUEST->input('payload.cvc') }}" step="1" />
    ...
    <div class="flex-1 p-2">
        <label for="app-payload-expires" class="form-label">{{ __('app-update.payload.expires') }}</label>

        <div class="input-group">
            <input type="password" name="payload[expires]" class="form-control form-control-lg" id="app-payload-expires" value="{{ $REQUEST->input('payload.expires') }}" step="1" />
